...
class TodoViewWidget extends StatefulWidget {
  ...
  @override
  State<TodoViewWidget> createState() => _TodoViewWidgetState();
}
...
class _TodoViewWidgetState extends State<TodoViewWidget>
  ...
  void initState() {
    ...
    animationsMap.addAll({
      ...
      'checkboxOnPageLoadAnimation3': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        effectsBuilder: () => [
          MoveEffect(
            curve: Curves.easeInOut,
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TodoRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final todoViewTodoRecord = snapshot.data!;
                              ...
                              children: [
                                Theme(
                                  data: ThemeData(
                                    ...
                                    unselectedWidgetColor: const Color(0xFF39D2C0),
                                  ),
                                  child: Checkbox(
                                    ...
                                    checkColor: const Color(0xFFE50913),
                                  ),
