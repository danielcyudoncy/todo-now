...
import '/components/task_created_widget.dart';
...
class CreateTodoWidget extends StatefulWidget {
  ...
  final DocumentReference? todoEdit;
                    ...
                    final datePickedDate = await showDatePicker(
                      ...
                      builder: (context, child) {
                        return wrapInMaterialDatePickerTheme(
                          ...
                          selectedDateTimeBackgroundColor: const Color(0xFF029837),
                          selectedDateTimeForegroundColor: Colors.black,
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        await TodoRecord.collection
                            ...
                            .set(createTodoRecordData(
                              ...
                              task1: _model.textController1.text,
                              task2: _model.textController2.text,
                              task3: _model.textController3.text,
                            ));
                      ...
                      options: FFButtonOptions(
                        ...
                        borderRadius: BorderRadius.circular(8.0),
                        hoverColor: const Color(0xFFD58413),
